...
public class ExtentReport {
	...
	String driverpath="F:\\Study Material\\6th SEM\\Test Automation Lab\\chromedriver.exe";
	WebDriver driver;
	
	@BeforeClass
	public void initializeReport() {
		report= new ExtentReports("F:\\Study Material\\6th SEM\\Test Automation Lab\\Selenium_Project\\extent1.html",true);
	}
